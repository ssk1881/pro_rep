        ...
        <section id="content-1-1" class="content-block content-0-1 min-height-600px bg-white">
            <div class="container text-center">
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <p class="lead">Welcome to Admin page... Hi <?php $id=$_SESSION["username"]; echo"$id"; ?> </p>
                </div>
                 <div class="col-sm-6 col-xs-12">
                                <a href="javascript:child_open()" class="btn btn-block btn-primary">Salary</a>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <a href="memdata.php" class="btn btn-block btn-warning"><span class="fa fa-check"></span>Employee List</a>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <a href="profile.php" class="btn btn-block btn-warning"><span class="fa fa-check"></span>Profile</a>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <a href="memdata.php" class="btn btn-block btn-primary"><span class="fa fa-check"></span>Manager List</a>
                            </div>
            </div>
        </section>
